<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/menu.Master" CodeBehind="tecnico.aspx.vb" Inherits="EQUIPO.Formulario_web11" %>
...
<div class="container text-center">
    Codigo: <asp:TextBox ID="tcodigo" class="form-control" runat="server"></asp:TextBox>
     ...
     <div class="mb-3">
     <label for="exampleInputPassword1" class="form-label">Tecnicos</label>
